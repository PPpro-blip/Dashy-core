/**
 * Inline SVG icon set — no external icon dependency required.
 * All icons are 24×24, stroke-based (lucide-style) to match the
...
export const BrainIcon = (p: IconProps) => (
  <Svg {...p}>
    ...
    <path d="M17.6 16.9a3.1 3.1 0 0 0-5.2 1.6" />
  </Svg>
);
...
/** X (Twitter) brand glyph — white on dark per brand guidelines. */
...
/** WhatsApp glyph — handset mark, always paired with WA green. */
...
/** LinkedIn brand glyph — white "in" on brand blue. */
