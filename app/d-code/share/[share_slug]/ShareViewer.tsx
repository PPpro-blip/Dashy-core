...
/**
 * DashyCore v7 — /d-code/share/[share_slug] client viewer (public, read-only).
 *
 ...
 * is is_public = true (plus the anon SELECT grant). Deliberately outside
 * the authenticated route group — no sidebar, no auth guard — with its own
 * minimal public chrome.
 *
 * The server `page.tsx` wrapper owns generateMetadata so X / WhatsApp /
 * LinkedIn crawlers see real Open Graph tags for this slug.
 */
